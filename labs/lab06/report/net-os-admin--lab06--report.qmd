...
![name](image/01.jpg){#fig-01  width=70%}
...
![name](image/02.jpg){#fig-02  width=70%}
...
![name](image/03.jpg){#fig-03  width=70%}
...
![name](image/05.jpg){#fig-05  width=70%}
...
![name](image/06.jpg){#fig-06  width=70%}
...
![name](image/07.jpg){#fig-07  width=70%}
...
![name](image/08.jpg){#fig-08  width=70%}
...
![name](image/09.jpg){#fig-09  width=70%}
...
![name](image/10.jpg){#fig-10  width=70%}
...
![name](image/11.jpg){#fig-11  width=70%}
...
![name](image/12.jpg){#fig-12  width=70%}
...
![name](image/13.jpg){#fig-13  width=70%}

Вышел из MariaDB и проверил список баз и таблиц:

	  mysqlshow -u root -p
	  mysqlshow -u qscalizaya -p addressbook

([рис. 14]).

![name](image/14.jpg){#fig-14  width=70%}
...
![name](image/15.jpg){#fig-15  width=70%}
...
![name](image/16.jpg){#fig-16  width=70%}
